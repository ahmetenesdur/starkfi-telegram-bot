...
export const MODEL_OPTIONS: Record<Provider, ModelOption[]> = {
	openai: [
		...
		{ id: "gpt-5.4", label: "GPT-5.4", description: "Most powerful reasoning" },
	],
	claude: [
		{ id: "claude-haiku-4-5", label: "Haiku 4.5", description: "Fastest & cheapest" },
	...
	gemini: [
		...
		{ id: "gemini-2.5-pro", label: "Gemini 2.5 Pro", description: "Advanced reasoning" },
		{
			...
			description: "Next-gen, frontier-class (preview)",
		},
	],
};

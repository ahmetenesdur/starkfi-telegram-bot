...
export async function startCommand(ctx: BotContext): Promise<void> {
	...
	await ctx.reply(
		`Hey ${name}, welcome to <b>StarkFi Bot</b>!\n\n` +
			...
			"Swap tokens, stake, liquid stake, lend, deposit to yield vaults, monitor positions, rebalance your portfolio, and simulate transactions — all through natural conversation.\n\n" +
